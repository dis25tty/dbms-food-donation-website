...
<head>
  ...
  <title>Provide Requests Details</title>
            ...
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    ...
                    <ul class="right hide-on-med-and-down">                        
                        <li><a href="#" class="waves-effect waves-block waves-light"><i class="">FOOD DHAANI</i></a>
                        </li>
                    </ul>						
                </div>
            </nav>
  ...
  <div id="main">
    ...
    <div class="wrapper">
                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold">
                            <div class="collapsible-body">
                                <ul>
								<li><a href="orders.php">All Requests</a>
                                </li>
								<?php
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Provide Request Details</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
				<div class="container">
          <p class="caption">Provide required Location.</p>
                    ...
                    <form class="formValidate col s12 m12 l6" id="formValidate" method="post" action="confirm-order.php" novalidate="novalidate">
                      <div class="row">
                        <div class="input-field col s12">
							<!-- <label for="payment_type"></label><br><br> -->
							<!-- <select id="payment_type" name="payment_type"> -->
									<option value="Wallet" selected></option>
									<option value="" <?php if(!$verified) echo 'disabled';?>></option>							
							</select>
                        </div>
                      </div>					
                      <div class="row">
                      ...
                      <!-- <div class="row">
                        <div class="input-field col s12">
                          <i class="mdi-action-credit-card prefix"></i>
							...
							<label for="cc_number" class="">Food taken for?</label>
                      ...
                      <!-- <div class="row">
                        <div class="input-field col s12">
                          <i class="mdi-communication-vpn-key prefix"></i>	
							...
							<label for="cvv_number" class="">Contact Number</label>								
