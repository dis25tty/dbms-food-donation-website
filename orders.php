...
<style>
body {
  background-image: url('https://as2.ftcdn.net/v2/jpg/03/78/97/59/1000_F_378975954_G39M4ptXAjxKy80gbBIEo0wqBkk89gBF.jpg');
        ...
        <!-- <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/materialize-logo.png" alt="logo"></a> <span class="logo-text">Food Dhaani</span></h1></li>
                    </ul>
                    <ul class="right hide-on-med-and-down">                        
                        <li><a href="#"  class="waves-effect waves-block waves-light"><i class="mdi-editor-attach-money">FOOD DHAANI</i></a>
                        </li>
                    </ul>						
                </div>
            </nav>
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i>Request Food</a>
            </li>
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i> Requests</a>
                            <div class="collapsible-body">
								...
								if(!isset($_GET['status'])){
									...
									"><a href="orders.php">All Requests</a>
                                </li>
								<?php
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Past Requests</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">List of your past Requests with details</p>
...
<div id="work-collections" class="seaction">
					...
					$sql = mysqli_query($con, "SELECT * FROM  WHERE customer_id = $user_id AND status LIKE '$status';;");
					echo '              <div class="row">
                <div>
					...
					while($row = mysqli_fetch_array($sql))
					{
						...
						while($row1 = mysqli_fetch_array($sql1))
						{
                            ...
                            <div class="col s2">
                            <span>'.$row1['quantity'].' People</span>
                            </div>
                             <div class="col s3">
							...
							$id = $row1['order_id'];
								...
								echo'<li class="collection-item">
                                        <div class="row">
                                            <div class="col s7">
                                                <p class="collections-title">Your Request has been sent to the owner,Please check the status and contact the owner</p>
                                            </div>
                                            <div class="col s2">
											<span> </span>
                                            </div>
