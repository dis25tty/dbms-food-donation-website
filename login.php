...
<style>
body {
  background-image: url('https://www.peoplesfundraising.com/image/1019ec13-ff0b-4698-9c94-e1ee8e004723');
      ...
      <form method="post" action="routers/router.php" class="login-form" id="form">
        <div class="row">
          <div class="input-field col s12 center">
            <p class="center login-form-text"><h1><b><font size=6px;>FOOD DHAANI</p></h1></b>
          </div>
        </div>
