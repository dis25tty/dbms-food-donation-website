...
body {
  ...
  <title>Foods that are Available</title>
  ...
  <div id="main">
    ...
    <div class="wrapper">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Food Menu</a>
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i>Requests</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="all-orders.php">All Request</a>
                                </li>
								<?php
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Food Available</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Update or Remove Excess Food Item in your hotel as admin.</p>
          <div class="divider"></div>
		  <form class="formValidate" id="formValidate" method="post" action="routers/menu-router.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Food Update from your hotel</h4>
              </div>
              <div>
				...
				while($row = mysqli_fetch_array($result))
				{
					...
					echo '<td><div class="input-field col s12 "><label for="'.$row["id"].'_price">No of people it can feed</label>';
					echo '<input value="'.$row["people"].'" id="'.$row["id"].'_price" name="'.$row['id'].'_price" type="text" data-error=".errorTxt'.$row["id"].'"><div class="errorTxt'.$row["id"].'"></div></td>';                   
					echo '<td>';
					if($row['deleted'] == 0){
						$text1 = 'selected';
						$text2 = '';
		  ...
		  <form class="formValidate" id="formValidate1" method="post" action="routers/add-item.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Add food items</h4>
              </div>
              <div>
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="name">No of People it can feed</th>
                      </tr>
                    </thead>
				...
				<?php
					...
					echo '<td><div class="input-field col s12 "><label for="price" class="">No of people it can feed</label>';
