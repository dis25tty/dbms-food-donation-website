    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Food Available</a>
            </li>
                <li class="no-padding">
                        ...
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i>Requests</a>
                            <div class="collapsible-body">
								...
								if(!isset($_GET['status'])){
									...
									"><a href="all-orders.php">All Requests</a>
                                </li>
								<?php
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">All Requests</h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">List of Requests by customers with details</p>
						...
						while($row1 = mysqli_fetch_array($sql1))
						{
                            ...
                            <span>'.$row1['quantity'].' People</span>
								...
								echo'<li class="collection-item">
                                        <div class="row">
                                            <div class="col s7">
                                                <p class="collections-title">Update the food available</p>
                                            </div>
                                            <div class="col s2">
											<span> </span>
                                            </div>
